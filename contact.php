                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="contact-info">
                            ...
                            <div class="contact-info-item">
                                ...
                                <div class="contact-info-text">
                                    <h3>Call Us</h3>
                                    <p><a style="color:white;" href="whatsapp://send?text=Hello! &phone=+918879176038">+918879176038</a></p>
                                </div>
                            </div>
                            <div class="contact-info-item">
                                <div class="contact-info-icon">
                                ...
                                <div class="contact-info-text">
                                    <h3>Email Us</h3>
                                    <p><i class="fa fa-envelope"></i>  <a style="color: white;" href="mailto:gavinsportx@gmail.com">gavinsportx@gmail.com</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-7">
                        <div class="contact-form">
                            <div id="success"></div>
                            <form  action="myformcontactus.php" method="POST">
...
<div style="margin: 20px;" class="alert alert-warning alert-dismissible fade show"  role="alert">
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
                    ...
                    <div class="col-md-12">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3773.736274402645!2d72.8294660143748!3d18.94306396106143!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7b870ba222b0b%3A0xa35fb09925b0951d!2sSt.%20Xavier&#39;s%20College!5e0!3m2!1sen!2sin!4v1649834179958!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
            </div>
        </div>
